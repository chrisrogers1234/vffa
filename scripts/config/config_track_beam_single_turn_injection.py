...
class Config(config.Config):
    def __init__(self, angle = None, r0 = None):
        ...
        self.run_control["output_dir"] = src_dir.replace("find", "track")
        ...
        # CHECK! do we find a closed orbit - if not then we need to turn off bump
        ...
        self.track_beam = {
            ...
            "settings":[{
                ...
                "beam":{
                    ...
                    "eigen_emittances":eigen_emittances,
                    "n_per_dimension":1,
                    "variables":["x","x'","y","y'"],
